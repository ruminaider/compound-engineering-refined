...
## [2.22.1-custom] - 2026-01-22

### Removed

- **Bundled MCP servers** - Removed duplicate Playwright (`pw`) and Context7 MCP servers
  - Use official `playwright@claude-plugins-official` and `context7@claude-plugins-official` instead
  - This reduces context window usage by eliminating duplicate tools

### Changed

- Updated README to recommend official plugins for Playwright and Context7
- Removed MCP-related keywords from plugin.json

### Summary

- 21 agents, 17 commands, 8 skills (no MCP servers - use official plugins)
